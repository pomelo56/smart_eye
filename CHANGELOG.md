...
> 本版本与 v0.8.2 代码一致，仅提升版本号用于验证应用内更新链路可正常下载并安装新版本。

---

## [0.8.2] — 2026-07-10 (应用内更新端到端测试)

### Changed
- 更新检查提前到服务初始化之后、相机权限检查之前，即使用户因权限问题无法使用相机，也能收到修复版本的更新提示。

> 本版本与 v0.8.1 代码基本一致，用于验证应用内更新链路。
