...
## [0.9.0-rc2] — 2026-07-11 (开发文档沉淀)

### Documentation
- 新增`docs/wiki/`目录，沉淀7篇开发经验Wiki文档，覆盖快速上手、架构设计、无障碍开发、音频系统、踩坑手册、安全加固、测试发布全流程，方便后续开发者接手项目和为其他视障辅助项目提供参考。

### Fixed
- 修复`scripts/release-github.sh`中`local`关键字在函数外使用导致GitHub Release创建失败的问题。
